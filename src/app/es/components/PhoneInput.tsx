...
const countries: Country[] = [
  ...
  { code: 'AE', name: 'EAU', dialCode: '+971', flag: '🇦🇪' },
]

export default function PhoneInput({ value, onChange, placeholder = 'Ingrese su número de teléfono', required = false, className = '', id, name }: PhoneInputProps) {
