      ...
      <div className="bg-gradient-to-r from-slate-900 via-gray-900 to-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300">Manage your bookings and explore our economical fleet</p>
          </div>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg border border-green-100 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm text-gray-600 font-medium">Active Rentals</p>
              ...
              <div className="p-6">
                {loadingBookings ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 mb-6">Start your economical car rental journey today!</p>
                    <button
                      onClick={() => router.push('/en/fleet')}
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className="font-medium text-gray-900">Book a Car</span>
                      <p className="text-xs text-gray-600">Browse our economical fleet</p>
                    </div>
                  </div>
                </button>
                <button
