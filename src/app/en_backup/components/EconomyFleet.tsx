...
export default function EconomyFleet({ limit = 6 }: { limit?: number }) {
        ...
        <div key={car.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
          <div className="relative h-48">
            ...
            <div className="absolute top-4 left-4">
              <span className="bg-green-600 text-white px-3 py-1 rounded-full text-sm font-semibold">{car.category}</span>
            </div>
          </div>
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div className="flex items-center"><span className="text-sm text-gray-600">{car.category}</span></div>
            </div>
