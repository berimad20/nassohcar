        ...
        <div className="flex flex-wrap items-center justify-between h-16">
          ...
          <nav className="hidden lg:flex flex-grow justify-center items-center">
            <div className="flex flex-wrap justify-center gap-x-4 xl:gap-x-8">
              ...
              <Link href="/en/contact" className="text-gray-200 hover:text-amber-400 transition-all duration-300 font-medium text-lg tracking-wide relative group whitespace-nowrap px-3 py-2 flex-shrink-0">
        ...
        {isMenuOpen && (
          <div className="lg:hidden">
            <div className="px-2 pt-4 pb-6 space-y-2 bg-gradient-to-b from-slate-900/95 to-gray-900/95 backdrop-blur-md border-t border-amber-400/20 rounded-b-2xl">
              ...
              <Link href="/en/contact" className="block px-4 py-3 text-gray-200 hover:text-amber-400 hover:bg-white/5 rounded-xl transition-all duration-300 font-medium" onClick={toggleMenu}>
                <span>Contact Us</span>
              </Link>
